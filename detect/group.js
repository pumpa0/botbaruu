...
join = '\`\`\`New Member\`\`\` \n \`\`\`Nama :\`\`\` \n \`\`\`Askot : \`\`\` \n \`\`\`Umur :\`\`\` \n \`\`\`Status :\`\`\` \n\n - [ Welcome👋 ] -'
leave = '_*YAH KNPA OUT? BEBAN GRUP YA👋*_'
...
module.exports = welcome = async (gura, anu) => {
        ...
        buttons = [
          ...
          { buttonId: `${setting.prefix}hai`, buttonText: { displayText: "WELCOME KAK👋" }, type: 1 },
        ...
        buttonsMessage = {
          ...
          footerText: "Welcome message By Maul",
      ...
      if (anu.action == "remove" && !mem.includes(gura.user.jid)) {
        ...
        buttons = [
          ...
          { buttonId: `${setting.prefix}oke`, buttonText: { displayText: "BEBAN GRUP OUT" }, type: 1 },];
        ...
        buttonsMessage = {
          ...
          footerText: "Leave Message By Maul",
